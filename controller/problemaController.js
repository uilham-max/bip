...
const getDetalhe = async (req, res) => {
    ...
    if(!problema){
        res.render('problema/detalhe', {user: usuarioNome(req, res), problema: problema, mensagem: "Erro ao buscar problema."})
    }
...
const getLista = async (req, res) => {
    ...
    if(problemas == ""){
        res.render('problema/lista', {user: usuarioNome(req, res), problemas: problemas, mensagem: "Lista vazia."})
    }
    if(!problemas){
        res.render('problema/lista', {user: usuarioNome(req, res), problemas: problemas, mensagem: "Erro ao buscar a lista de problemas."})
    }
...
const postNovo = async (req, res) => {
    ...
    if(!insert){
        res.render('problema/novo', {user: usuarioNome(req, res), mensagem: 'Erro ao enviar problema.'})
    }
    res.render('problema/novo', {user: usuarioNome(req, res), mensagem: "Seu problema foi enviado com sucesso!"})
}
